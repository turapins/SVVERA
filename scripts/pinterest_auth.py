...
Scopes cover both reading (search your own pins/boards) and writing
(create boards/pins for the character database) — see
tools/research/pinterest_reference.py and tools/publishers/pinterest_boards.py.
"""
import os
import sys
import urllib.parse
